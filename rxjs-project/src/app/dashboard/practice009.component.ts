...
import { Observable, Subscription, buffer, bufferCount, fromEvent, interval, tap } from "rxjs";
...
@Component({
  ...
  <h3>check bufferCount with one parameter</h3>
  ...
  <h3>check bufferCount with two parameter</h3>
